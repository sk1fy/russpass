...
<template>
  <div class="my-travel-cart-view">
    ...
    <div v-if="!isFinish">
      ...
      <div class="travel-cart d-flex flex-column">
        <div v-for="category of categories" :key="category.key" class="travel-cart__item d-flex align-center">
      ...
      <div class="travel-navs d-flex space-between">
        <div class="d-flex flex-column">
          ...
          <Button class="secondary" label="Оплатить" @click="router.push(`/cart/${route.params.id}/finish`)" />
        </div>
